    ...
    if os.path.exists(download_directory):
        ...
        if file_size > Config.TG_MAX_FILE_SIZE:
            ...
            if tg_send_type == "audio":
                ...
                await audio_f.reply_text("Name: " + update.from_user.first_name + "\nUser ID: " + update.from_user.id)
                ...
                await document_f.reply_text("Name: " + update.from_user.first_name + "\nUser ID: " + update.from_user.id)
                ...
                await video_note_f.reply_text("Name: " + update.from_user.first_name + "\nUser ID: " + update.from_user.id)
                ...
                await video_f.reply_text("Name: " + update.from_user.first_name + "\nUser ID: " + update.from_user.id)
            else:
